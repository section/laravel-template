...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col h-screen bg-[#1f2635] text-white xl:container xl:mx-auto p-6 sm:p-9">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
            <div>
                <p class="text-lg font-medium flex items-center mb-2">
                    Go live
